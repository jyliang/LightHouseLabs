...
//        UIButton.appearance(whenconstr)
        UIButton.appearance(whenContainedInInstancesOf: [ViewController.self]).setTitleColor(UIColor.white, for: .normal)
        self.window?.tintColor = UIColor.green
        UISwitch.appearance().tintColor = UIColor.purple
    }
